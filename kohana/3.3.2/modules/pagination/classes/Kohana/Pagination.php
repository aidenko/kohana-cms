...
class Kohana_Pagination {
	...
	protected $sLaCode = null;
	protected $iLaId = null;
	...
	public function __construct(array $config = array(), Request $request = NULL)
	{
		...
		$this->sLaCode = $this->_request->param('lang');
	...
	public function render($view = NULL)
	{
		...
		return $view->set(get_object_vars($this))->set('page', $this)->set('lang', $this->sLaCode.'/pagination')->render();
	}
