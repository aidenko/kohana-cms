...
<p class="pagination">
	...
	<?php if ($first_page !== FALSE): ?>
		<a href="<?php echo HTML::chars($page->url($first_page)) ?>" rel="first"><?=I18n::get('First', $lang)?></a>
	<?php else: ?>
		<?=I18n::get('First', $lang)?>
	<?php endif ?>

	<?php if ($previous_page !== FALSE): ?>
		<a href="<?php echo HTML::chars($page->url($previous_page)) ?>" rel="prev"><?=I18n::get('Previous', $lang)?></a>
	<?php else: ?>
		<?=I18n::get('Previous', $lang)?>
	<?php endif ?>
	...
	<?php if ($next_page !== FALSE): ?>
		<a href="<?php echo HTML::chars($page->url($next_page)) ?>" rel="next"><?=I18n::get('Next', $lang)?></a>
	<?php else: ?>
		<?=I18n::get('Next', $lang)?>
	<?php endif ?>

	<?php if ($last_page !== FALSE): ?>
		<a href="<?php echo HTML::chars($page->url($last_page)) ?>" rel="last"><?=I18n::get('Last', $lang)?></a>
	<?php else: ?>
		<?=I18n::get('Last', $lang)?>
	<?php endif ?>
